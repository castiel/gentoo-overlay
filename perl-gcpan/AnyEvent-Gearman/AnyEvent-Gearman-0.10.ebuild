...
DEPEND="dev-perl/Test-Base
	>=dev-perl/AnyEvent-6.100.0
	dev-perl/Test-Exception
	>=perl-gcpan/Object-Event-1.23
	perl-gcpan/MouseX-Foreign
	>=dev-perl/Test-TCP-1.180.0
	>=dev-perl/Any-Moose-0.180.0
	>=dev-perl/Mouse-0.970.0
	>=perl-gcpan/Object-Container-0.14
	dev-perl/Test-Deep
	dev-lang/perl"
