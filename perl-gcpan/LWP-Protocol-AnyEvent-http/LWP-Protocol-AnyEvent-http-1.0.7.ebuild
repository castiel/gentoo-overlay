...
SRC_URI="http://puppet.silverlineweb.com/LWP-Protocol-AnyEvent-http-1.0.7.tar.gz"

inherit perl-module

DESCRIPTION="Event loop friendly HTTP and HTTPS backend for LWP"
...
DEPEND="perl-gcpan/Software-License
	dev-perl/HTTP-Daemon
	dev-perl/libwww-perl
	dev-perl/AnyEvent
	dev-perl/URI
	>=dev-perl/AnyEvent-HTTP-2.140.0
