...
# $Header: /var/cvsroot/gentoo-x86/net-misc/memcached/memcached-1.4.5.ebuild,v 1.7 2010/04/30 14:29:09 ranger Exp $
...
IUSE="test slabs-reassign debug sasl replication" # hugetlbfs later
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-1.4.5-repcached.patch"
